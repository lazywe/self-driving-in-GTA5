...
2.Remember to manually download the model_data / yolo.h5 file and put it in the model_data folder.Because it is a large file, it does not download automatically when git clone**  
