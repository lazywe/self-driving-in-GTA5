...
2.记得下载model_data/yolo.h5文件并放到项目model_data文件夹里面，因为它是大文件，git clone的时候没有自动下载  
1.README is divided into Chinese version and English version, English version is at the bottom  
2.Remember to download the model_data / yolo.h5 file and put it in the model_data folder.Because it is a large file, it does not download automatically when downloading**  
